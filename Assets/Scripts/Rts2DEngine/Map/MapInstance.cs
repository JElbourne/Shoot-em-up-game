...
namespace Rts2DEngine
{
    namespace Map
    {
        ...
        {
            public Vector2 mapSize = new Vector2(8, 8); // Grid Size that holds individual rooms.
            ...
            private void Awake()
            {
                ...
                m_Grid = GetComponent<PathGrid>();
            }
            #endregion

            public Vector2 GetGridWorldSize()
            {
                return new Vector2(mapSize.x * roomTilesWide, mapSize.y * roomTilesHigh);
            }
            ...
            public Vector2[] GetWorldPanLimit()
            {
                ...
                panLimits[1] = new Vector2((mapSize.x * roomTilesWide) - roomTilesWide / 2 + 2f, (mapSize.y * roomTilesHigh) - roomTilesHigh / 2 + 0.5f);
                return panLimits;
            }
            ...
            {
                return m_Grid.NodeFromWorldPoint(worldPosition);
            }
